...
permettant d'effectuer rapidement une multiplication sur GF(2^32) (lookup-table).
...
disponsant d'une sonde indiquant à la louche combien "d'aléatoire" j'ai dedans.
