...
Cependant, le vrai problème était celui de la gestion de l'IaC.
...
déclare une ressource, que l'on souhaite avoir dans un état défini, mais les
...
grâce à ça, pour éviter les "ça marche sur telle machine mais pas sur celle-là", ou pour
...
Lors du processus de boot, le kernel est chargé en mémoire, ainsi que l'initramfs
...
L'initramfs et son processus init _"font des choses"_, et passent le flambeau
...
normal, non privilégié, et la création de [char device](https://linux-kernel-labs.github.io/refs/heads/master/labs/device_drivers.html) avec [`mknodat(2)`](https://linux.die.net/man/2/mknodat) n'est pas
...
[Cette page contient également des informations sur les char devices et major/minor dans linux](https://www.oreilly.com/library/view/linux-device-drivers/0596000081/ch03s02.html)
{: .notice--info }
...
appliquer pour Ansible se traduit par une liste de "stages", c'est à dire un liste de playbooks
...
Un des avantages de Vauban comme nous l'avions évoqué précemment est son approche
...
La dernière étape n'a pas modifié de paquets
{: .notice--success }
